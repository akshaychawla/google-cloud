from modelBuilder import resnet_50_fulltune_drop
import numpy as np
import cv2
...
def main():
	...
	print "Saving history to folder ./snapshots fname: history.pkl"
	import cPickle as pickle 
	with open("./snapshots/history.pkl","wb") as f:
